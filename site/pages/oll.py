#!/usr/bin/python3
import dash
dash.register_page(__name__, path='/oll')
...
region_name = 'Oll'  # Use the appropriate region name
region_data = regions[region_name]
center_lat = (region_data[2] + region_data[3]) / 2
center_lon = (region_data[0] + region_data[1]) / 2
zoom_level = 7   # Determine an appropriate zoom level based on the region
area = 'oll'
